...
<button type="button" onclick="location.href = '/publisher_search';" >Search Publisher</button>
...
<p> User : <%= user_id %> </p>
<button type="button" onclick="location.href = '/search';">Search Books</button>
...
<button type="button" onclick="location.href = '/enable_book';">Enable Book</button>
<button type="button" onclick="location.href = '/disable_book';">Disable Book</button>
